...
description: "Fine tuning YOLOv8 and developing a web app with Streamlit."
...
intro: "This project aims to develop a computer vision system to detect and identify various aircraft types. The project is developed on top of open-source copmuter vision model Ultralytics YOLOv8 and publicly accesible aircraft detection datasets from Kaggle."
liveUrl: "https://aircraftdetector.streamlit.app"
...
<a href="https://aircraftdetector.streamlit.app/" target="_blank" rel="noopener noreferrer">Click to Access Project Website</a>
...
The <a href="https://aircraftdetector.streamlit.app/" target="_blank" rel="noopener noreferrer">web application</a> is built using **Streamlit**, providing an intuitive interface for real-time aircraft detection in both images and videos. The app architecture prioritizes security, performance, and user experience through several key design decisions.
...
The final result is a complete system that combines the trained YOLOv8 model with an intuitive web interface. It's a production-ready application that can identify 43 different aircraft types with solid accuracy. You can use it directly from: <a href="https://aircraftdetector.streamlit.app/" target="_blank" rel="noopener noreferrer">https://aircraftdetector.streamlit.app/</a>
...
In short, this project was a great learning opportunity for me. I had the chance to sharpen my technical skills in a new field of technology. The project is completely open-source, and all code, including the scripts for training, is in the [Github repo](https://github.com/faisaldurbaa/aircraft_detector). You can use the app directly from: <a href="https://aircraftdetector.streamlit.app/" target="_blank" rel="noopener noreferrer">https://aircraftdetector.streamlit.app/</a>
</Accordion>
